       ...
       <div style="display:flex;justify-content:space-between;">
        ...
        <el-tabs v-model="activeName" type="card" @tab-click="handleTabClick">
            ...
            <!-- <el-tab-pane label="商品规格" name="tab2"> -->
              <div style="    text-align: initial; padding:10px;">
...
<el-dialog :visible.sync="skuItemEditerBootData.show" :title="title" @open="openEditer" center width='800px' :close-on-click-modal="false">
    <el-form inline label-width="100px" size="small">
        <el-form-item v-for="(skuKey,index) in skuItemEditerBootData.skuKeyList" :key="skuKey.skuKeyIdName" :label="skuKey.skuKeyIdName">
            <el-select v-model="infoForm.attrs[skuKey.skuKeyIdName]" clearable placeholder="未选择" style="width:100px;" :disabled="disableStatus&&form.attrs[skuKey.skuKeyIdName]!=''">
    ...
    <el-form label-width="100px" size="small">
        ...
        <el-form-item label="库存量">
            <el-input v-model="infoForm.storageNum" style="width:200px;"></el-input>
        </el-form-item>

        <el-form-item label="供货价">
            <el-input v-model="infoForm.costPrice" style="width:200px;" :disabled="skuItemEditerBootData.specStatus"></el-input>
        </el-form-item>

        <el-form-item label="标签价">
            <el-input v-model="infoForm.labelPrice" style="width:200px;" :disabled="skuItemEditerBootData.specStatus"></el-input>
        </el-form-item>

        <el-form-item label="市场价">
            <el-input v-model="infoForm.marketPrice" style="width:200px;" :disabled="skuItemEditerBootData.specStatus"></el-input>
        </el-form-item>

        <el-form-item label="条码">
            <el-input v-model="infoForm.barCode" style="width:200px;"></el-input>
        </el-form-item>

        <el-form-item label="备注">
            <el-input v-model="infoForm.remark" style="width:300px;height:30px;"></el-input>
        </el-form-item>

        <upload-image-view @updateImageList="updateImageList" :imageUrlList="infoForm.imageList">
